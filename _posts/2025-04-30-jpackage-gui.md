---
title: JPackage GUI
description: JPackage GUI is a GUI Application that makes it easier for java developers to package their applications into end-user-friendly installers.
author: everdro1d
...
* <s>Monolith File - A single file that saves jpackage settings for all platforms.</s> **Done!**
